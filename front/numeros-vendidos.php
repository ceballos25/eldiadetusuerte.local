        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid" style="padding-top: 20px;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0 fw-bold"><i class="ti ti-ticket me-1"></i>Nros Vendidos</h2>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body py-3">
                        <div class="row g-2 align-items-end">
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Buscar Nro / Cliente</label>
                            ...
                            <table class="table table-hover align-middle mb-0 table-admin-cards">
                                <thead class="table-light sticky-top" style="z-index: 10;">
                                    <tr>
                                        ...
                                        <th class="d-none d-lg-table-cell text-center">Nro</th>
